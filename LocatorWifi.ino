...
void addKnownBeacons() {
  ...
  addBeacon("Beacon2", "44616f19-c598-456d-a1ef-2ecbd986794d", 0, 11);
  addBeacon("Beacon3", "3f21a6ea-5b3f-45d3-b7ec-42699025977d", 4.7, 0);
  addBeacon("Beacon4", "6e524cba-98db-4e38-870c-6e63d5257476", 4.7, 11);
}
...
void processPacket(float x, float y, int breathing, int heart) {
    if (newData == 1) {
        ...
        sprintf(createdPacket, "#x/%.2f#y/%.2f", x, y);
